...
// dataDir allows the host application (e.g. Flutter via FFI) to override
// the default data directory at runtime.
var dataDir string

// SetDataDir sets the data directory used by all path helpers.
func SetDataDir(dir string) {
	dataDir = dir
}

// GetDataDir returns the configured data directory, falling back to
// os.UserConfigDir()/youflac, then os.TempDir()/youflac.
...
// If SetDataDir was called, that path is used instead.
